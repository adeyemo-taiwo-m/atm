...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 overflow-hidden bg-[var(--color-white)]">
      <div className="text-center mb-16">
        <Heading>Client Stories</Heading>
        <p className="text-[var(--color-neutral-500)] max-w-xl mx-auto mt-4">
      ...
      <div className="relative overflow-hidden w-full py-4">
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[var(--color-white)] via-[var(--color-white)]/80 to-transparent z-20"></div>
        <div className="pointer-events-none absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[var(--color-white)] via-[var(--color-white)]/80 to-transparent z-20"></div>
        ...
        >
          {testimonials.concat(testimonials).map((t, i) => (
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="flex-shrink-0 w-[350px] tab:w-[450px] p-8 bg-[var(--color-white)] rounded-[32px] border border-[var(--color-neutral-200)] shadow-sm hover:shadow-xl hover:border-[var(--color-neutral-300)] transition-all duration-500"
            >
