...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "A next-generation music streaming platform featuring a sleek dark-themed interface, personalized discovery, and seamless playback.",
    role: "UI/UX Design",
    techStack: ["Figma", "Adobe Photoshop"],
    image: "/vibe-flow.png",
    designLink:
      "https://www.behance.net/gallery/243255523/VibeFlow-Music-Streaming-App",
    mode: "design",
    impact:
      "Achieved a 40% increase in playlist creation through intuitive UI.",
  },
];
...
export const designSteps = [
  {
    ...
    description:
      "I study the users, brand, and competitive landscape before touching Figma.",
  },
  {
    icon: <FaMap />,
  ...
  },
  {
    ...
    title: "Wireframing",
    description:
      "Lo-fi sketches in Figma to lock in layout and flow before visual design.",
  },
  {
    icon: <FaLayerGroup />,
    title: "Visual Design",
    description:
      "High-fidelity UI with a defined design system — colors, type, spacing, components.",
  },
  {
    icon: <FaUsersCog />,
    title: "Handoff & Iteration",
    description:
      "Annotated specs delivered to developers. I stay involved through QA.",
  },
];
...
export const devSteps = [
  {
    ...
    description:
      "I break down the spec into components, data flow, and edge cases.",
  },
  {
    icon: <FaTools />,
    title: "Architecture Planning",
    description:
      "I define the folder structure, state management approach, and API contracts.",
  },
  {
    icon: <FaCode />,
    title: "Component Development",
    description:
      "I build reusable, accessible components with Tailwind and React.",
  },
  {
    icon: <FaLink />,
    title: "Integration & Testing",
    description:
      "APIs wired in, cross-browser tested, Lighthouse performance checked.",
  },
  {
    icon: <FaRocket />,
    title: "Deployment & Handover",
    description:
      "Deployed on Vercel/Netlify with documentation and handover notes.",
  },
];
